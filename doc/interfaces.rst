...
can register a new interface by using the ``can.interface`` entry point in
its project configuration. The format of the entry point depends on your project
...
.. code-block:: python
    ...
    bus = can.Bus("interface_name", channel=0)
